...
address price increases but also investigate how these changes affect different demographics and the overall housing market dynamics 
in the region. Additionally, we recognized the importance of examining external factors like interest rates and economic policies 
that could further influence housing trends. Ultimately, EDA underscored the necessity of integrating additional variables
like income levels and property characteristics for a more comprehensive analysis. This shift allowed us to develop a more nuanced 
understanding of the housing market in the DMV area.

Based on exploratory data analysis (EDA), it appears that housing prices in the D.C., Maryland, and Virginia (DMV) areas are 
trending upwardfrom 2021 to 2023. The Zillow Home Value Index (ZHVI) suggests a consistent increase in home values across 
various zip codes, particularly within the 35th to 65th percentiles. However, the limitations of using Zillow’s data, 
such as reliance on properties listed on their platform and potential discrepancies in the Zestimate, indicate that 
while the data provides valuable insights, it may not fully represent the broader market dynamics. Factors like income 
levels, property characteristics, and local economic conditions could further elucidate the housing market 
trends in the DMV area. Addressing these variables through additional research could enhance the understanding of housing 
