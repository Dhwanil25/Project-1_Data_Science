...
over a longer period of time so one NA would not be detrimental to the study of the trend. One way to remedy these 
limitation would be take different sources of data on housing data and have a comparable value between them in order 
