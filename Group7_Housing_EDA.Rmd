...
Based on this first model we can observe year doesn't have much of an impact on the log of ZHVI. However the home being in Maryland or Virginia decreases ZHVI. with the coefficient of year being positive, we can see that log ZHVI will increase by 5.64% within each year of our data. 

Housing values in Maryland are lower than the reference state by approximately 17.2% (after accounting for the year and metro variables).

Housing values in Virginia are lower than the reference state by 13.7%.
